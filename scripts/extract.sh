...
SOURCE_ZIP="package-sources/rtl-sdr-blog-master.zip"
...
mv /tmp/rtl-sdr-blog-master/* "$DEST_DIR"/
rm -rf /tmp/rtl-sdr-blog-master
...
Homepage: https://github.com/foonerd/rtlsdr-blog
...
foonerd-rtlsdr (1.0.0-1) bookworm; urgency=medium
  ...
  * Custom build from rtl-sdr-blog/rtl-sdr-blog source
  * Binary prefix: fn-*
